  ...
  return (
    <>
      ...
      <div className="wrap">
        ...
        <div className="grid">
          <SpotlightCard className="gcell cursor-target" spotlightColor="rgba(99, 174, 242, 0.12)"><h4><span className="d"></span>Competitor Recon Agent</h4><p>Maps a niche&apos;s competitive landscape — named competitors, funded startups, comparison pages — from one target.</p><p className="num">→ <b>100+</b> companies mapped · 15+ competitors each</p><p className="tools">Claude Agent SDK · Google SERP · proxy</p></SpotlightCard>
          <SpotlightCard className="gcell cursor-target" spotlightColor="rgba(99, 174, 242, 0.12)"><h4><span className="d"></span>Employee Intelligence DB</h4><p>MongoDB tracking employees at target accounts with first/last-seen + status — for hiring / churn triggers.</p><p className="num">→ <b>3</b> target accounts · daily deltas</p><p className="tools">MongoDB · schema-driven snapshots</p></SpotlightCard>
          <SpotlightCard className="gcell cursor-target" spotlightColor="rgba(99, 174, 242, 0.12)"><h4><span className="d"></span>Shopify Merchant Classifier</h4><p>Agent that discovers &amp; classifies Shopify stores and agencies from search results for outreach.</p><p className="num">→ <b>2,029</b> stores classified</p><p className="tools">Claude Agent SDK · Apify · Cheerio</p></SpotlightCard>
          <SpotlightCard className="gcell cursor-target" spotlightColor="rgba(99, 174, 242, 0.12)"><h4><span className="d"></span>Crunchbase Exporter</h4><p>Resumable batch scraper for funded-company data with progress checkpointing and recovery.</p><p className="num">→ <b>25,200</b> funded companies exported</p><p className="tools">Playwright · resumable state</p></SpotlightCard>
          <SpotlightCard className="gcell cursor-target" spotlightColor="rgba(99, 174, 242, 0.12)"><h4><span className="d"></span>Smartlead Campaign Agent</h4><p>CLI agent that creates and manages outbound campaigns through the Smartlead API.</p><p className="num">→ full campaign lifecycle via API</p><p className="tools">Claude Agent SDK · Smartlead API</p></SpotlightCard>
          <SpotlightCard className="gcell cursor-target" spotlightColor="rgba(99, 174, 242, 0.12)"><h4><span className="d"></span>Email Finder TUI</h4><p>Interactive terminal tool for name-+-company email lookup via LeadMagic, with a live blessed UI.</p><p className="num">→ name + company → verified email</p><p className="tools">Node · blessed · LeadMagic</p></SpotlightCard>
          <SpotlightCard className="gcell cursor-target" spotlightColor="rgba(99, 174, 242, 0.12)"><h4><span className="d"></span>Apollo Headcount Lookup</h4><p>Rate-limited CLI resolving company headcount from Apollo for domains or names, streamed to CSV.</p><p className="num">→ domain / name → headcount</p><p className="tools">TypeScript · Apollo · streaming CSV</p></SpotlightCard>
          <SpotlightCard className="gcell cursor-target" spotlightColor="rgba(99, 174, 242, 0.12)"><h4><span className="d"></span>Post-Engagement Scraper</h4><p>Exports everyone who commented on a target LinkedIn post — warm signals for outreach.</p><p className="num">→ <b>1,210</b> commenters / post</p><p className="tools">Node · Apify</p></SpotlightCard>
        </div>
